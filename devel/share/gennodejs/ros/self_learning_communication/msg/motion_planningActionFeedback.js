...
class motion_planningActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new motion_planningFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = motion_planningFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new motion_planningActionFeedback(null);
    ...
    data.feedback = motion_planningFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new motion_planningActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = motion_planningFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new motion_planningFeedback()
    }
...
module.exports = motion_planningActionFeedback;
